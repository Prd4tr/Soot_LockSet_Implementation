...
public class RunDataFlowAnalysis
{
	public static void main(String[] args) {
		...
		*/
		String mainClass = "Locks";
		System.out.println("Analyzing class: "+mainClass);
		// You may have to update the class Path based on your OS and Java version 
		/*** *** YOU SHOULD EDIT THIS BEFORE RUNNING *** ***/
		//String classPath = "E:/Implement/SootExamples"; 			//change to appropriate path to the test class
															// if needed add path to rt.jar (or classes.jar)

		String classPath = System.getProperty("user.dir") + File.separator + "LiveAnalysis";
